 ...
 * This file demonstrates how to integrate Preampnook with a web frontend
 */

// For React/Vue/Angular applications
export class PreampnookClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new PreampnookClient(provider, contractAddress);
